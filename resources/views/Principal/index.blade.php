            ...
            <div class="col-md-4">
                <div class="header_social">
                    <ul>
                        ...
                        <li><a href="{{url('Login')}}"><i class="fa fa-rss"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="rev_slider fullwidthabanner"  data-version="5.3.0.2" id="home-slider">
            <ul>
                <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
                    <!-- MAIN IMAGE -->
                    <img src="img/Images-ferreterias/slider_1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="slider_text_box">
                        ...
                        <div class="tp-caption first_text"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             data-elementdelay="0.05" >Bienvenido a nuestra
                        </div>
                        ...
                        <div class="tp-caption third_text"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             data-elementdelay="0.05" >Ferreteria L&D
                        </div>
                ...
                <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
                    <!-- MAIN IMAGE -->
                    <img src="img/Images-ferreterias/slider_2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
