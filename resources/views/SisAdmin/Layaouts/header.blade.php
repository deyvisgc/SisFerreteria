...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/kartik-v-bootstrap-fileinput/css/fileinput.min.css')}}"  media="all" rel="stylesheet" type="text/css">
    <link href="{{asset('css/tabs.css')}}" media="all" rel="stylesheet" type="text/css" />
    <link href="{{asset('css/loading.css')}}" media="all" rel="stylesheet" type="text/css" />
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{url('categorias')}}">Usuarios y Categorias</a></li>
                            <li><a class="nav-link" href="{{url('Servicios')}}">Servicios</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Gestion Productos</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{url('Productos')}}">Productos</a></li>
                            <li><a class="nav-link" href="{{url('Accesorios')}}">Accesorios</a></li>
                        </ul>
                    </li>
                    <!--
                <li class="nav-item dropdown">
...
<script src="{{asset('assets/kartik-v-bootstrap-fileinput/themes/fa/theme.js')}}"></script>
